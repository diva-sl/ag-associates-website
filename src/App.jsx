...
function HomePage() {
  return (
    <>
      {" "}
      <Hero /> <About /> <Services /> <WhyChooseUs /> <CTA /> <Contact />{" "}
      <FAQ />
    </>
  );
}
  ...
  return (
    <HelmetProvider>
      <>
        ...
        <meta
          name="description"
          content="AG & ASSOCIATES offers expert tax consultancy in Tirupur, providing services for GST, direct taxation, financial planning, compliance management, and business advisory services."
        />
        <script type="application/ld+json">
          {`
      {
